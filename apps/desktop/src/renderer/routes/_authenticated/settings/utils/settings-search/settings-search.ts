...
export const SETTINGS_ITEMS: SettingsItem[] = [
	...
	},
	{
		...
		section: "behavior",
		title: "Delete local branch on agent removal",
		description:
	...
	},
	{
		...
		description:
			"Show CPU and memory usage for agents and terminal sessions in the top bar",
		keywords: [
			"features",
			"resource",
			"monitor",
	...
	},
	{
		...
		section: "billing",
		title: "Usage limits",
		description: "Track agent and user limits",
		keywords: [
			"billing",
			"usage",
			"limits",
	...
	},
	{
		...
		keywords: ["team", "name", "rename", "title", "label"],
	},
	{
		id: SETTING_ITEM_ID.PROJECT_PATH,
		section: "project",
		title: "Repository Path",
		description: "The file path to this team",
		keywords: [
			"team",
			"path",
			"repository",
	...
	},
	{
		...
		section: "project",
		title: "Scripts",
		description: "Setup and teardown scripts for agents",
		keywords: [
			"team",
			"scripts",
			"setup",
	...
	},
	{
		...
		section: "project",
		title: "Branch Prefix",
		description: "Override the default branch prefix for this team",
		keywords: [
			"team",
			"branch",
			"prefix",
