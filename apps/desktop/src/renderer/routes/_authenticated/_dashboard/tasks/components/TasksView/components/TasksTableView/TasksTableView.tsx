							...
							{isGroupHeader ? (
								...
								>
									...
									<div
										...
										tabIndex={0}
										className={cn(
											"grid items-center gap-3 px-4 h-12 cursor-pointer border-b border-border/50 hover:bg-muted/30",
											row.getIsSelected() && "bg-accent/30",
										)}
										style={{
											gridTemplateColumns: `24px ${slugColumnWidth} 32px 1fr auto auto auto auto auto auto`,
										}}
